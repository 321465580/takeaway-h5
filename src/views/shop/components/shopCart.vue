        ...
        <VanPopup v-model:show="isCartListShown" round position="bottom">
            <div class="shop-cart__popup">
                ...
                <div class="popup__all">
                    <van-checkbox checked-color="rgb(31, 175, 243)" :model-value="store.isAllChecked"
                        @update:model-value="(isAllChecked) => store.toggleAllcheckd(isAllChecked)">
                        <span class="all-label">全选</span>
                    </van-checkbox>
                    <div class="all-total">(已选{{ store.total }}件)</div>
                    <span class="all-remove" @click="removeAll">
                        <VanIcon name="delete-o" />清空
                    </span>
                </div>
                ...
                <div class="cart-info">
                    <div class="cart-info__price">
                        <template v-if="store.total">
                            <span class="cart-info__price--now">￥{{ store.totalPrice }}</span>
